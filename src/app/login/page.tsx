...
//       } catch (error: unknown) {
//         const errorMessage = error instanceof FirebaseError ? error.message : "Ha ocurrido un error inesperado.";
//         console.error('Error de autenticación:', error);
//         Swal.fire({
//           icon: "error",
//           title: "Error de autenticación",
//           text: error instanceof FirebaseError ? error.message : "Ha ocurrido un error inesperado.",
//         });
//       }
//     }
//   };
